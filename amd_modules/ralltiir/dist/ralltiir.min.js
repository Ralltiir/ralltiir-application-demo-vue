...
A.redirect(r,null,n,o),s.addClass(e,R)}}}function v(t,e){for(var r=t;null!==r&&r.tagName!==e.toUpperCase();)r=r.parentNode;return r}var m,y,w,b,q,_,R,A=new f,j={},O=p();return A.init=function(){l.init(this.dispatch),A.pages=m=r.create("pages",{onRemove:function(t,e,r){o.isFunction(t.onRemove)&&t.onRemove(e,r)},limit:32}),y=!1,R="visited",q="/",w="/",b=!0,_=0},A.getState=function(){return j},A.regist=function(t,e){i(t,"invalid path pattern"),i(e,"invalid service"),e.singleton=!0,l.register(t,null,e)
},A.unregist=function(t){l.unRegister(t)},A.dispatch=function(t,e){i(t,"cannot dispatch with options:"+t),A.emit("dispatching",{current:t,previous:e,extra:j});var r=o.get(t,"options.src"),n=l.getOrCreate(e.url,e.pathPattern);e.service=n;var s=l.getOrCreate(t.url,t.pathPattern,"history"!==r&&"back"!==r);t.service=s,m.contains(t.url)||m.set(t.url,{id:_,isIndex:b}),t.page=m.get(t.url),e.page=m.get(e.url);var u=j;return j={},y&&(y=!1,t.options.src="back"),t.options&&"sync"===t.options.src?w=t.url||"/":b=!1,c.ensureAttached(),O.reset([function(){return n?n.singleton?n.detach(t,e,u):n.beforeDetach(t,e,u):void 0
},function(){return s?s.singleton?s.create(t,e,u):s.beforeAttach(t,e,u):void 0},function(){return n?n.singleton?n.destroy(t,e,u):n.detach(t,e,u):void 0},function(){return s?s.attach(t,e,u):void 0}]).exec(function(){s&&s.abort&&s.abort(t,e,u)})},A.isIndexPage=function(){return b},A.exist=function(t){return l.isRegistered(t)},A.config=function(e){e=e||{},e.root&&(q=e.root),e.visitedClassName&&(R=e.visitedClassName),t.config(e)},A.redirect=function(r,n,i,s){A.emit("redirecting",r),r=h(r),o.assign(j,s),i=o.assign({},i,{id:_++});
try{i.silent&&d(r,n),t.redirect(r,n,i)}catch(a){throw a.url=u.resolve(q,r),e.replace(a.url),A.emit("redirectFailed",a),a}},A.back=function(){y=!0,a.back()},A.reset=function(e,r,n,i){b&&(w=e),d(e,r),o.assign(j,i),t.reset(e,r,n)},A.start=function(e){arguments.length&&A.config(e),document.body.addEventListener("click",g),t.start()},A.stop=function(){document.body.removeEventListener("click",g),t.stop(),t.clear()},A.destroy=function(){A.stop(),r.destroy("pages"),l.destroy(),A.pages=m=void 0,l.unRegisterAll()
},A.update=function(r,n,i,o){i=i?i:{},i.hasOwnProperty("silent")||(i.silent=!0);var s=t.ignoreRoot(e.pathname+e.search),u=t.createURL(s).toString(),a=t.ignoreRoot(r),c=(a||"").replace(/\?.*/,""),f=t.getState(),l={from:{url:u},to:{url:a,path:c},extra:o};return A.partialUpdate(r,{replace:!0,state:f,transition:l,to:o&&o.container&&o.container.get(0),query:n,options:i})},A.partialUpdate=function(r,i){var s=t.ignoreRoot(e.pathname+e.search),u=t.createURL(s).toString(),a=m.get(u);d(r,i.query),i=o.assign({},{fromUrl:r,replace:!1,routerOptions:{},page:a},i);
