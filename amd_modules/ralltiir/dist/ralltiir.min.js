...
},c.stop=function(){i.dispose(),c.clear(),l={}},c.controller=function(t){var e=i;i=t,o.forOwn(e,function(t,e){i.hasOwnProperty(e)||(i[e]=t)})},c.getState=function(){return l},c.ignoreRoot=i.ignoreRoot,c.createURL=i.createURL,c}{var r=t("sfr/lang/underscore").extend,n=t("sfr/router/router/config"),i=t("sfr/router/router/controller"),o=t("sfr/lang/underscore");t("sfr/utils/logger")}return e}),define("sfr/utils/di",["require","sfr/lang/assert","sfr/lang/underscore"],function(t){function e(t){this.config=this.normalize(t),this.container=Object.create(null)
...
for(var r in t)if(t.hasOwnProperty(r)&&e(t[r],r,t)===!1)break;return t}function c(t){return t?T.slice.call(t):[]}function f(t){var e=o(arguments);return T.forEach.apply(t||[],e)}function l(t,e){if(q(t)){var r=o(arguments);return T.map.apply(t||[],r)}var n=[];return a(t,function(){n.push(e.apply(null,arguments))}),n}function p(t,e,r){if(q(t)){var n=o(arguments);return T.reduce.apply(t,n)}var i,s,a=u(t);for(arguments.length>=3?(i=r,s=0):a.length>0&&(i=t[a[0]],s=1);s<a.length;s++){var c=a[s];i=e(i,t[c],c,t)
}return i}function h(t){var e=o(arguments);return T.slice.apply(t||[],e)}function d(t){var e=o(arguments);return T.splice.apply(t||[],e)}function g(t){var e=o(arguments);return D.split.apply(t||"",e)}function v(t,e,r){for(var n=r||0;n<t.length;n++)if(e(t[n],n,t))return n;return-1}function m(t){return o(arguments).reduce(function(t,e){return t.replace("%s",e)},t)}function y(){return O.apply(null,h(arguments,0).reverse())}function w(t){var e=typeof t;return null!=t&&("object"===e||"function"===e)}function b(t){return"number"==typeof t&&t>-1&&t%1===0&&Q>=t
...
}}),define("sfr/action",["require","sfr/utils/cache","sfr/lang/promise","sfr/lang/assert","sfr/utils/logger","sfr/lang/underscore","sfr/utils/dom","sfr/utils/url"],function(t){function e(t,e,a,c,f,l){function p(){function t(t){return u=t,s=(s+1)%i,a}function e(t){var e=s;return o.isFunction(r)&&r(),r=t,n.mapSeries(u,function(t){return"function"==typeof t&&e===s?t():void 0}).catch(function(t){setTimeout(function(){throw t})}).then(function(){r=null})}var r,i=1e4,s=0,u=[],a={reset:t,exec:e,aborted:!1};
return a}function h(t){var e=u.parse(t);return"sfr"===e.scheme&&"index"===e.host?w:t}function d(r,n){var i=t.ignoreRoot(e.pathname+e.search),o=t.createURL(i).toString(),s=t.createURL(r,n).toString();m.rename(o,s)}function g(t){t=t||window.event;var e=v(t.target||t.srcElement,"A");if(e){var r=e.getAttribute("data-sf-href"),n=e.getAttribute("data-sf-options");if(r){t.preventDefault();try{n=JSON.parse(n)||{}}catch(i){console.warn("JSON parse failed, fallback to empty options"),n={}}n.src="hijack";var o={event:t,anchor:e};
_.redirect(r,null,n,o),s.addClass(e,R.visitedClassName)}}}function v(t,e){for(var r=t;null!==r&&r.tagName!==e.toUpperCase();)r=r.parentNode;return r}var m,y,w,b,q,_=new f,R={},A={},j=p();return _.init=function(){l.init(this.dispatch),_.pages=m=r.create("pages",{onRemove:function(t,e,r){o.isFunction(t.onRemove)&&t.onRemove(e,r)},limit:32}),y=!1,R={root:"/",visitedClassName:"visited"},w="/",b=!0,q=0},_.getState=function(){return A},_.regist=function(t,e){i(t,"invalid path pattern"),i(e,"invalid service"),e.singleton=!0,l.register(t,null,e)
},_.unregist=function(t){l.unRegister(t)},_.dispatch=function(t,e){i(t,"cannot dispatch with options:"+t),_.emit("dispatching",{current:t,previous:e,extra:A});var r=o.get(t,"options.src"),n=l.getOrCreate(e.url,e.pathPattern);e.service=n;var s=l.getOrCreate(t.url,t.pathPattern,"history"!==r&&"back"!==r);t.service=s,m.contains(t.url)||m.set(t.url,{id:q,isIndex:b}),t.page=m.get(t.url),e.page=m.get(e.url);var u=A;return A={},y&&(y=!1,t.options.src="back"),t.options&&"sync"===t.options.src?w=t.url||"/":b=!1,c.ensureAttached(),j.reset([function(){return n?n.singleton?n.detach(t,e,u):n.beforeDetach(t,e,u):void 0
},function(){return s?s.singleton?s.create(t,e,u):s.beforeAttach(t,e,u):void 0},function(){return n?n.singleton?n.destroy(t,e,u):n.detach(t,e,u):void 0},function(){return s?s.attach(t,e,u):void 0}]).exec(function(){s&&s.abort&&s.abort(t,e,u)})},_.isIndexPage=function(){return b},_.exist=function(t){return l.isRegistered(t)},_.config=function(e){return 0!==arguments.length&&(o.assign(R,e),t.config(R)),R},_.redirect=function(r,n,i,s){_.emit("redirecting",r),r=h(r),o.assign(A,s),i=o.assign({},i,{id:q++});
try{i.silent&&d(r,n),t.redirect(r,n,i)}catch(a){throw a.url=u.resolve(R.root,r),e.replace(a.url),_.emit("redirectFailed",a),a}},_.back=function(){y=!0,a.back()},_.reset=function(e,r,n,i){b&&(w=e),d(e,r),o.assign(A,i),t.reset(e,r,n)},_.start=function(e){arguments.length&&_.config(e),document.body.addEventListener("click",g),t.start()},_.stop=function(){document.body.removeEventListener("click",g),t.stop(),t.clear()},_.destroy=function(){_.stop(),r.destroy("pages"),l.destroy(),_.pages=m=void 0,l.unRegisterAll()
},_.update=function(r,n,i,o){i=i?i:{},i.hasOwnProperty("silent")||(i.silent=!0);var s=t.ignoreRoot(e.pathname+e.search),u=t.createURL(s).toString(),a=t.ignoreRoot(r),c=(a||"").replace(/\?.*/,""),f=t.getState(),l={from:{url:u},to:{url:a,path:c},extra:o};return _.partialUpdate(r,{replace:!0,state:f,transition:l,to:o&&o.container&&o.container.get(0),query:n,options:i})},_.partialUpdate=function(r,i){var s=t.ignoreRoot(e.pathname+e.search),u=t.createURL(s).toString(),a=m.get(u);d(r,i.query),i=o.assign({},{fromUrl:r,replace:!1,routerOptions:{},page:a},i);
var c=l.getOrCreate(r),f=c.partialUpdate(r,i);return i.routerOptions.silent=!0,t.reset(r||e.href,i.query,i.routerOptions),n.resolve(f)},_.init(),_}var r=t("sfr/utils/cache"),n=t("sfr/lang/promise"),i=t("sfr/lang/assert"),o=(t("sfr/utils/logger"),t("sfr/lang/underscore")),s=t("sfr/utils/dom"),u=t("sfr/utils/url");return e}),define("sfr/service",["require"],function(){var t=function(){};return t.prototype.create=function(){},t.prototype.attach=function(){},t.prototype.detach=function(){},t.prototype.destroy=function(){},t.prototype.update=function(){},t
}),define("sfr/services",["require","sfr/lang/map","sfr/lang/underscore","sfr/lang/assert","sfr/utils/logger","sfr/utils/cache"],function(t){var e=t("sfr/lang/map"),r=t("sfr/lang/underscore"),n=t("sfr/lang/assert"),i=(t("sfr/utils/logger"),t("sfr/utils/cache"));return function(t){function o(t){return w.serviceInstances.setLimit(t)}function s(t){y=new e,m=t,v=w.urlEntries=new e,g=w.serviceInstances=i.create("services",{onRemove:function(t,e,n){r.isFunction(t.destroy)&&t.destroy(e,n)},limit:8})}function u(){i.destroy("services")
}function a(e,r,i){n(e,"invalid path pattern"),n(!v.has(e),"path already registerd"),t.add(e,m),v.set(e,{service:i,config:r})}function c(t){return v.has(t)}function f(){v.keys().forEach(l),v.clear()}function l(e){n(e,"invalid path pattern"),n(c(e),"path not registered"),t.remove(e),v.delete(e)}function p(t){var e=y.get(t);return void 0===e?void 0:g.get(e)}function h(t,e){var r=b++;return y.set(t,r),e.id=r,g.set(r,e),e}function d(e,r){var n=p(e);if(n)return n;arguments.length<2&&(r=t.pathPattern(e));
var i=v.get(r);if(i){var o=i.service,s=i.config,u=o.singleton?o:new o(e,s);return h(e,u)}}var g,v,m,y,w={init:s,destroy:u,register:a,unRegister:l,isRegistered:c,unRegisterAll:f,getOrCreate:d,setInstanceLimit:o,urlEntries:null},b=0;return w}}),define("sfr/resource",["require","sfr/utils/http","sfr/lang/underscore"],function(t){function e(t){this.url=t}var r=t("sfr/utils/http"),n=t("sfr/lang/underscore");return e.prototype={getUrl:function(t){var e=this.url;return n.forOwn(t,function(t,r){e=e.replace(":"+r,t)
}),e=e.replace(/:[a-zA-Z]\w*/g,"")},create:function(t,e){var n=this.getUrl(e);return r.post(n,t)},query:function(t){var e=this.getUrl(t);return r.get(e)},update:function(t,e){var n=this.getUrl(e);return r.put(n,t)},"delete":function(t){var e=this.getUrl(t);return r.delete(e)}},e.prototype.constructor=e,e}),define("sfr/view",["require"],function(){var t=function(){this._init()};return t.prototype={constructor:t,_init:function(){},set:function(){},get:function(){},create:function(){},render:function(){},update:function(){},attach:function(){},detach:function(){},destroy:function(){},on:function(){},off:function(){}},t
